...
```{r timeplot, out.width='100%', fig.height=4.8}
...
```{r fig.width=8, fig.height=8}
wordcloud(tweets, "hashtags", min_count = 2, min_size = 1, max_words = 80)
```
